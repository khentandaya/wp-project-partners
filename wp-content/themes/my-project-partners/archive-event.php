...
<main id="primary" class="site-main pb-4">
  ...
  <section class="mb-4">
    <?php
        ...
        // The query. Would probably be better to use pre_get_posts in functions.php so the archive doesn't run the event query before the below one.
    ...
    <?php
        ...
        echo 'There are no ' . $event_type . ' events';
      endif;
      ?>
