...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211108_projectpartnersdashboard_6e3ac914186fe7009177_20211108123550_archive.zip';
	const ARCHIVE_SIZE		 = '51552650';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6e3ac91-08123550';
    const SECONDARY_PACKAGE_HASH = '4c97eb7-08123550';
	const VERSION			 = '1.4.3';
